...
<head>
    ...
    <link rel="stylesheet" src="{{ asset('js/bootstrap-datepicker/css/bootstrap-datepicker.min.css')  }}">
    ...
    <div class=" container-scroller">
        ...
        <nav class="navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="bg-white text-center navbar-brand-wrapper">
                <!-- <a class="navbar-brand brand-logo" href="index.html"><img src="{{asset('star/images/logo_star_black.png')}}" /></a> -->
